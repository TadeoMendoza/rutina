...
if(document.getElementById("ejer7").classList.contains("hidden")){
    ...
    document.getElementById("terminarej7").addEventListener("click", () => {
        ...
        if(serie === 5){
            ...
            document.getElementById("ejer8").classList.remove("hidden");
            serie=0;
        }
       
    })
}
if(document.getElementById("ejer8").classList.contains("hidden")){
    
    document.getElementById("terminarej8").addEventListener("click", () => {
        document.getElementById("ejer8").classList.remove("hidden");
        serie++;
        document.getElementById("ejer8series").innerHTML=serie;
        if(serie === 4){
            document.getElementById("ejer8").classList.add("hidden");
